...
namespace KotorTool_2._0.Forms
{
  public class frmCreateAnimListEntry : Form
  {
    ...
    {
      Load += frmCreateAnimListEntry_Load;
      al = new ArrayList();
      InitializeComponent();
    }
    ...
    private void btnOK_Click(object sender, EventArgs e)
    {
      ...
      if (cmbxAnimation.SelectedIndex == -1 && StringType.StrCmp(cmbxAnimation.Text, "", false) != 0)
        sLeft = cmbxAnimation.Text;
      else if (cmbxAnimation.SelectedItem != null)
        sLeft = StringType.FromInteger(((Anim) cmbxAnimation.SelectedItem).Number);
      if (StringType.StrCmp(sLeft, "", false) == 0 | !Information.IsNumeric(sLeft))
      {
      ...
      {
        AnimationNumber = IntegerType.FromString(sLeft);
