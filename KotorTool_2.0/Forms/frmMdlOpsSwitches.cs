...
// Type: KotorTool_2.frmMdlOpsSwitches
...
namespace KotorTool_2._0.Forms
{
  public class frmMdlOpsSwitches : Form
  {
    ...
    internal virtual CheckBox chkbMdlAlignDataOnly
    {
      ...
      [MethodImpl(MethodImplOptions.Synchronized)] set
      {
        if (_chkbMdlAlignDataOnly != null)
          _chkbMdlAlignDataOnly.CheckedChanged -= chkbMdlAlignDataOnly_CheckedChanged;
    ...
    private void InitializeComponent()
    {
      ...
      Decimal num1 = new Decimal(new int[4]{ 10000, 0, 0, 0 });
      Decimal num2 = num1;
    ...
    private void chkbMdlAlignDataOnly_CheckedChanged(object sender, EventArgs e)
    {
      chkbExportMdlAlignData.Checked = !chkbMdlAlignDataOnly.Checked;
    }
