...
// Type: KotorTool_2.frmProjectManagerProperties
...
namespace KotorTool_2._0.Forms
{
  public class frmProjectManagerProperties : frmParent
  {
    ...
    internal virtual Button btnReleasePath
    {
      ...
      [MethodImpl(MethodImplOptions.Synchronized)] set
      {
        if (_btnReleasePath != null)
          _btnReleasePath.Click -= btnReleasePath_Click;
    ...
    internal virtual Button btnSelectProject
    {
      ...
      [MethodImpl(MethodImplOptions.Synchronized)] set
      {
        if (_btnSelectProject != null)
          _btnSelectProject.Click -= btnSelectProject_Click;
    ...
    private void InitializeComponent()
    {
      ...
      MinimumSize = size1;
      Name = "frmProjectManagerProperties";
