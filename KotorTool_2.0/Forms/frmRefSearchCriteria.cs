...
// Type: KotorTool_2.frmRefSearchCriteria
...
namespace KotorTool_2._0.Forms
{
  public class frmRefSearchCriteria : frmParent
  {
    ...
    internal virtual TextBox tbSearchString
    {
      ...
      [MethodImpl(MethodImplOptions.Synchronized)] set
      {
        if (_tbSearchString != null)
          _tbSearchString.TextChanged -= tbSearchString_TextChanged;
    ...
    internal virtual Button btnSetAll
    {
      ...
      {
        if (_btnSetAll != null)
          _btnSetAll.Click -= btnSetAll_Click;
        _btnSetAll = value;
        if (_btnSetAll == null)
          return;
        _btnSetAll.Click += btnSetAll_Click;
    ...
    internal virtual CheckBox chkbScripts
    {
      ...
      [MethodImpl(MethodImplOptions.Synchronized)] set
      {
        if (_chkbScripts != null)
          _chkbScripts.CheckedChanged -= chkbScripts_CheckedChanged;
        _chkbScripts = value;
        if (_chkbScripts == null)
          return;
        _chkbScripts.CheckedChanged += chkbScripts_CheckedChanged;
    ...
    internal virtual CheckBox chkbTemplates
    {
      ...
      [MethodImpl(MethodImplOptions.Synchronized)] set
      {
        if (_chkbTemplates != null)
          _chkbTemplates.CheckedChanged -= chkbTemplates_CheckedChanged;
    ...
    internal virtual CheckBox chkbRIMs
    {
      ...
      {
        if (_chkbRIMs != null)
          _chkbRIMs.CheckedChanged -= chkbRIMs_CheckedChanged;
        _chkbRIMs = value;
        if (_chkbRIMs == null)
          return;
        _chkbRIMs.CheckedChanged += chkbRIMs_CheckedChanged;
    ...
    internal virtual CheckBox chkbAllBifs
    {
      ...
      [MethodImpl(MethodImplOptions.Synchronized)] set
      {
        if (_chkbAllBifs != null)
          _chkbAllBifs.CheckedChanged -= chkbAllBifs_CheckedChanged;
        _chkbAllBifs = value;
        if (_chkbAllBifs == null)
          return;
        _chkbAllBifs.CheckedChanged += chkbAllBifs_CheckedChanged;
    ...
    internal virtual RadioButton rbSearchKotor1
    {
      ...
      [MethodImpl(MethodImplOptions.Synchronized)] set
      {
        if (_rbSearchKotor1 != null)
          _rbSearchKotor1.CheckedChanged -= rbSearch_CheckedChanged;
    ...
    internal virtual RadioButton rbSearchKotor2
    {
      ...
      [MethodImpl(MethodImplOptions.Synchronized)] set
      {
        if (_rbSearchKotor2 != null)
          _rbSearchKotor2.CheckedChanged -= rbSearch_CheckedChanged;
    ...
    private void chkbScripts_CheckedChanged(object sender, EventArgs e)
    {
      gboxScript.Enabled = chkbTemplates.Checked | chkbRIMs.Checked | chkbScripts.Checked | chkbAllBifs.Checked;
    }
