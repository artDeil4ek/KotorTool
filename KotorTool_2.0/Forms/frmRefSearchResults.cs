...
// Type: KotorTool_2.frmRefSearchResults
...
namespace KotorTool_2._0.Forms
{
  public class frmRefSearchResults : frmParent
  {
    ...
    [AccessedThroughProperty("lbMatches")]
    private ListBox _lbMatches;
    ...
    internal virtual ListBox lbMatches
    {
      ...
      [MethodImpl(MethodImplOptions.Synchronized)] set
      {
        if (_lbMatches != null)
        {
          _lbMatches.DoubleClick -= lbMatches_DoubleClick;
          _lbMatches.SelectedIndexChanged -= lbMatches_SelectedIndexChanged;
        }
        _lbMatches = value;
        if (_lbMatches == null)
          return;
    ...
    private void lbMatches_DoubleClick(object sender, EventArgs e)
    {
      if (lbMatches.SelectedIndex == -1)
        return;
        //HandleDataByNodeType((KotorTreeNode) lbMatches.SelectedItem, null);
    }
