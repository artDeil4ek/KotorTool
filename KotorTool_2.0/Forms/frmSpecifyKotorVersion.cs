...
// Type: KotorTool_2.frmSpecifyKotorVersion
...
namespace KotorTool_2._0.Forms
{
  public class FrmSpecifyKotorVersion : Form
  {
    ...
    internal virtual RadioButton rbKotor1
    {
      ...
      {
        if (_rbKotor1 != null)
          _rbKotor1.CheckedChanged -= rb_CheckedChanged;
        _rbKotor1 = value;
        if (_rbKotor1 == null)
          return;
        _rbKotor1.CheckedChanged += rb_CheckedChanged;
    ...
    internal virtual RadioButton rbKotor2
    {
      ...
      {
        if (_rbKotor2 != null)
          _rbKotor2.CheckedChanged -= rb_CheckedChanged;
        _rbKotor2 = value;
        if (_rbKotor2 == null)
          return;
        _rbKotor2.CheckedChanged += rb_CheckedChanged;
