...
namespace KotorTool_2._0.Models.CLS
{
  public class ClsUtc : ClsGff
  {
    ...
    {
      GStructArr = new object[40];
      LateBinding.LateIndexSet(GStructArr, new object[2] {0,new GffStruct()}, null);
    ...
    {
      return ((GffStruct[]) GStructArr)[IntegerType.FromObject(n)];
    }

    public GffStruct[] StructArray()
    {
      return (GffStruct[]) GStructArr;
    }
  }
}
