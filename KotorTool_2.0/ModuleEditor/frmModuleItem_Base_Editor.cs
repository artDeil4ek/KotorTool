...
// Type: KotorTool_2.frmModuleItem_Base_Editor
  ...
  public class frmModuleItem_Base_Editor : frmParent
  {
    ...
    internal virtual Button btnShowQuaternion
    {
      ...
      [MethodImpl(MethodImplOptions.Synchronized)] set
      {
        ...
        {
          _btnShowQuaternion.MouseUp -= btnShowQuaternion_MouseUp;
          _btnShowQuaternion.MouseDown -= btnShowQuaternion_MouseDown;
        }
    ...
    internal virtual NumericUpDown nudCamOrientationX
    {
      ...
      [MethodImpl(MethodImplOptions.Synchronized)] set
      {
        if (_nudCamOrientationX != null)
          _nudCamOrientationX.ValueChanged -= nudCamOrientation_ValueChanged;
    ...
    internal virtual NumericUpDown nudCamOrientationY
    {
      ...
      [MethodImpl(MethodImplOptions.Synchronized)] set
      {
        if (_nudCamOrientationY != null)
          _nudCamOrientationY.ValueChanged -= nudCamOrientation_ValueChanged;
    ...
    internal virtual NumericUpDown nudCamOrientationZ
    {
      ...
      [MethodImpl(MethodImplOptions.Synchronized)] set
      {
        if (_nudCamOrientationZ != null)
          _nudCamOrientationZ.ValueChanged -= nudCamOrientation_ValueChanged;
    ...
    internal virtual NumericUpDown nudXYSpawnPointBearing
    {
      ...
      [MethodImpl(MethodImplOptions.Synchronized)] set
      {
        ...
        {
          _nudXYSpawnPointBearing.KeyUp -= nudXYSpawnPointBearing_KeyUp;
          _nudXYSpawnPointBearing.ValueChanged -= nudXYSpawnPointBearing_ValueChanged;
        }
    ...
    internal virtual ListBox lbSpawnPoints
    {
      ...
      [MethodImpl(MethodImplOptions.Synchronized)] set
      {
        if (_lbSpawnPoints != null)
          _lbSpawnPoints.SelectedIndexChanged -= lbSpawnPoints_SelectedIndexChanged;
    ...
    public float SpawnPointBearing
    {
      ...
      {
        _Bearing = value;
        _SpawnPointXYAngle = (double) _Bearing >= 0.0 ? _Bearing / Math.PI * 180.0 : _Bearing / Math.PI * 180.0 + 360.0;
        DrawXYOrientationSpawnPointBearing();
        tbBearing.Text = StringType.FromSingle(value);
        nudXYSpawnPointBearing.ValueChanged -= nudXYSpawnPointBearing_ValueChanged;
    ...
    public GffType16 CameraOrientationQuat
    {
      get
      {
        ...
        gffType16.W = Convert.ToSingle(x1 / num10);
        gffType16.X = Convert.ToSingle(x2 / num10);
        gffType16.Y = Convert.ToSingle(x3 / num10);
        gffType16.Z = Convert.ToSingle(x4 / num10);
        return gffType16;
      }
      set
      {
    ...
    {
      get => new GffType17() { X = Convert.ToSingle(nudCamOrientationX.Value), Y = Convert.ToSingle(nudCamOrientationY.Value), Z = Convert.ToSingle(nudCamOrientationZ.Value) };
      set
      {
    ...
    private void InitializeComponent()
    {
      ...
      MaximizeBox = false;
      MinimizeBox = false;
      Name = "frmModuleItem_Base_Editor";
    ...
    public void SetupOrientationIndicators()
    {
      ...
      if (_XYAngle < 0.0) _XYAngle = _XYAngle + 360.0;
    ...
    public float get_Bearing(int ModItemType)
    {
      if (ModItemType == 2044)
      {
        if (_XYAngle > 90.0) return (float) ((270.0 - _XYAngle) / 180.0 * Math.PI);
        return (float) (-(_XYAngle + 90.0) / 180.0 * Math.PI);
      }
      ...
      if (_XYAngle > 180.0) return (float) (-(_XYAngle - 180.0) / 180.0 * Math.PI);
      return (float) ((180.0 - _XYAngle) / 180.0 * Math.PI);
    }
    ...
    private void nudCamOrientation_ValueChanged(object sender, EventArgs e)
    {
      ErrorProvider1.SetError(nudCamOrientationX, "");
    }
    ...
    private void nudXYSpawnPointBearing_KeyUp(object sender, KeyEventArgs e)
    {
      nudXYSpawnPointBearing.Value = nudXYSpawnPointBearing.Value;
    }
  }
}
