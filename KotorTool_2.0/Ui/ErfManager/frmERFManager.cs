...
// Type: KotorTool_2.frmERFManager
...
namespace KotorTool_2._0.Ui.ErfManager
{
    public class frmERFManager : frmParent
    {
        ...
        [AccessedThroughProperty("tbErfName")] private TextBox _tbErfName;
        [AccessedThroughProperty("btnBuild")] private Button _btnBuild;

        [AccessedThroughProperty("btnMoveDown")]
        private Button _btnMoveDown;

        [AccessedThroughProperty("btnMoveUp")] private Button _btnMoveUp;
        ...
        internal virtual ListBox ERFContentFiles
        {
            ...
            set
            {
                ...
                {
                    _ERFContentFiles.KeyUp -= ERFContentFilesOnKeyUp;
                    _ERFContentFiles.SelectedIndexChanged -= ERFContentFilesOnSelectedIndexChanged;
                    _ERFContentFiles.DragDrop -= ERFContentFilesDragDrop;
                    _ERFContentFiles.DragEnter -= ERFContentFilesDragEnter;
                }
        ...
        internal virtual Button btnAddFile
        {
            ...
            {
                if (_btnAddFile != null)
                    _btnAddFile.Click -= btnAddFileOnClick;
                _btnAddFile = value;
                if (_btnAddFile == null)
                    return;
                _btnAddFile.Click += btnAddFileOnClick;
        ...
        internal virtual Button btnRemoveItem
        {
            ...
            set
            {
                if (_btnRemoveItem != null)
                    _btnRemoveItem.Click -= btnRemoveItemOnClick;
        ...
        internal virtual Button btnMoveUp
        {
            ...
            {
                if (_btnMoveUp != null)
                    _btnMoveUp.Click -= btnMoveUpOnClick;
                _btnMoveUp = value;
                if (_btnMoveUp == null)
                    return;
                _btnMoveUp.Click += btnMoveUpOnClick;
        ...
        internal virtual Button btnMoveDown
        {
            ...
            set
            {
                if (_btnMoveDown != null)
                    _btnMoveDown.Click -= btnMoveDownOnClick;
                _btnMoveDown = value;
                if (_btnMoveDown == null)
                    return;
                _btnMoveDown.Click += btnMoveDownOnClick;
        ...
        internal virtual Button btnBuild
        {
            ...
            {
                if (_btnBuild != null)
                    _btnBuild.Click -= btnBuildOnClick;
                _btnBuild = value;
                if (_btnBuild == null)
                    return;
                _btnBuild.Click += btnBuildOnClick;
        ...
        internal virtual TextBox tbErfName
        {
            ...
            set
            {
                if (_tbErfName != null)
                {
                    _tbErfName.TextChanged -= tbErfNameOnTextChanged;
                    _tbErfName.ModifiedChanged -= tbErfNameOnModifiedChanged;
                }
        ...
        internal virtual ComboBox cmbxErfType
        {
            ...
            set
            {
                if (_cmbxErfType != null)
                    _cmbxErfType.SelectedIndexChanged -= cmbxErfTypeOnSelectedIndexChanged;
                _cmbxErfType = value;
                if (_cmbxErfType == null)
                    return;
                _cmbxErfType.SelectedIndexChanged += cmbxErfTypeOnSelectedIndexChanged;
        ...
        internal virtual Button btnSelectOutputFile
        {
            ...
            set
            {
                if (_btnSelectOutputFile != null)
                    _btnSelectOutputFile.Click -= btnSelectOutputFileOnClick;
        ...
        internal virtual Button btnAddDirectory
        {
            ...
            set
            {
                if (_btnAddDirectory != null)
                    _btnAddDirectory.Click -= btnAddDirectoryOnClick;
        ...
        {
            Load += frmERFManagerOnLoad;
            Closing += frmERFManagerOnClosing;
            InitializeComponent();
        ...
        private void ERFContentFilesDragEnter(object sender, DragEventArgs e)
        {
        ...
        private void ERFContentFilesDragDrop(object sender, DragEventArgs e)
        {
            if (e.Data.GetDataPresent(DataFormats.FileDrop))
            {
                ...
                while (index <= num2)
                {
                    ...
                    {
                        int num3 = (int) Interaction.MsgBox("The file \"" + data[index] + "\"" + " must be renamed to be no more than 16 characters long, not including the extension, to be used." + "\n" + "\n" + "The file will not be added.", MsgBoxStyle.Critical, "Filename too long");
                    }
                    else
        ...
        private void btnMoveUpOnClick(object sender, EventArgs e)
        {
            ...
            ListBox erfContentFiles = ERFContentFiles;
            erfContentFiles.SelectedIndex = checked(erfContentFiles.SelectedIndex - 1);
        }

        private void btnMoveDownOnClick(object sender, EventArgs e)
        {
            int selectedIndex = ERFContentFiles.SelectedIndex;
            if (selectedIndex >= checked(ERFContentFiles.Items.Count - 1)) return;
            string str = StringType.FromObject(ERFContentFiles.SelectedItem);
            ERFContentFiles.Items[selectedIndex] = RuntimeHelpers.GetObjectValue(ERFContentFiles.Items[checked(selectedIndex + 1)]);
            ERFContentFiles.Items[checked(selectedIndex + 1)] = str;
            ListBox erfContentFiles = ERFContentFiles;
        ...
        private void ERFContentFilesOnSelectedIndexChanged(object sender, EventArgs e)
        {
        ...
        private void btnRemoveItemOnClick(object sender, EventArgs e)
        {
            if (ERFContentFiles.SelectedIndices.Count == 1) RemoveItem();
        ...
        private void btnSelectOutputFileOnClick(object sender, EventArgs e)
        {
            string sLeft = StringType.FromObject(FileUtils.GetFilePath("save", ConfigOptions.Paths.DefaultSaveLocation, "", "Save ERF file...", ""));
            if (StringType.StrCmp(sLeft, "", false) == 0)
                return;
            tbErfName.Text = sLeft;
        }

        private void btnAddFileOnClick(object sender, EventArgs e)
        {
            OpenFileDialog openFileDialog = new OpenFileDialog();
            openFileDialog.InitialDirectory = ConfigOptions.Paths.DefaultImportLocation;
            ...
            if (openFileDialog.ShowDialog() == DialogResult.OK)
            {
                ...
                while (index < fileNames.Length)
                {
                    ...
                    {
                        Interaction.MsgBox("The file \"" + path + "\"" + " must be renamed to be no more than 16 characters long, not including the extension, to be used." + "\n" + "\n" + "The file will not be added.", MsgBoxStyle.Critical, "Filename too long");
                    }
                    else ERFContentFiles.Items.Add(path);
        ...
        private void btnAddDirectoryOnClick(object sender, EventArgs e)
        {
            ...
            foreach (object obj in list) ERFContentFiles.Items.Add(StringType.FromObject(obj));
        ...
        {
            string[] inputFileList = new string[ERFContentFiles.Items.Count - 1 + 1];
            int num1 = 0;
            int num2 = checked(ERFContentFiles.Items.Count - 1);
            int index = num1;
            while (index <= num2)
            {
            ...
            Interaction.MsgBox("ERF Build Complete");
            btnCancel.Text = "Done";
            btnCancel.Focus();
        }

        private void ERFContentFilesOnKeyUp(object sender, KeyEventArgs e)
        {
            if (e.KeyCode != Keys.Delete || ERFContentFiles.SelectedIndices.Count <= 0) return;
            if (ERFContentFiles.SelectedIndices.Count > 1)
            {
                if (Interaction.MsgBox("Remove all " + StringType.FromInteger(ERFContentFiles.SelectedIndices.Count) + "files?", MsgBoxStyle.OkCancel | MsgBoxStyle.DefaultButton2, "Confirm removal") != MsgBoxResult.Ok) return;
                int index = checked(ERFContentFiles.SelectedIndices.Count - 1);
                while (index >= 0)
                {
                    ERFContentFiles.Items.RemoveAt(ERFContentFiles.SelectedIndices[index]);
        ...
        private void tbErfNameOnModifiedChanged(object sender, EventArgs e)
        {
            CheckFieldsForBuild();
        }

        private void cmbxErfTypeOnSelectedIndexChanged(object sender, EventArgs e)
        {
            CheckFieldsForBuild();
            btnBuild.Text = StringType.FromObject(ObjectType.StrCatObj("Build ", cmbxErfType.SelectedItem));
        }

        private void tbErfNameOnTextChanged(object sender, EventArgs e)
        {
            CheckFieldsForBuild();
        }

        private void frmERFManagerOnLoad(object sender, EventArgs e)
        {
            PositionWindow(GetType().Name);
        }

        private void frmERFManagerOnClosing(object sender, CancelEventArgs e)
        {
           // SaveSettings(GetType().Name);
        }

        private void CheckFieldsForBuild()
        {
            if (ERFContentFiles.Items.Count > 0 && StringType.StrCmp(tbErfName.Text, string.Empty, false) != 0 && cmbxErfType.SelectedIndex != -1)
        ...
        {
            ERFContentFiles.Items.RemoveAt(ERFContentFiles.SelectedIndex);
        }
        ...
        private string BrowseForFolder()
        {
            ...
            folderBrowserDialog.SelectedPath = ConfigOptions.Paths.DefaultImportLocation;
