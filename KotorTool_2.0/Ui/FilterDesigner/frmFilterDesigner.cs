...
// Type: KotorTool_2.frmFilterDesigner
...
namespace KotorTool_2._0.Ui.FilterDesigner
{
  public class frmFilterDesigner : Form
  {
    ...
    internal virtual Button btnAddFilter
    {
      ...
      [MethodImpl(MethodImplOptions.Synchronized)] set
      {
        if (_btnAddFilter != null)
          _btnAddFilter.Click -= btnAddFilter_Click;
        _btnAddFilter = value;
        if (_btnAddFilter == null)
          return;
        _btnAddFilter.Click += btnAddFilter_Click;
    ...
    private void btnOK_Click(object sender, EventArgs e)
    {
      ...
      while (num3 <= num2)
      {
        ComboBox control1 = (ComboBox) FindControl("cn" + StringType.FromInteger(num3));
        TextBox control2 = (TextBox) FindControl("cr" + StringType.FromInteger(num3));
        ComboBox control3 = (ComboBox) FindControl("mo" + StringType.FromInteger(num3));
        if (control1.SelectedIndex != -1 & StringType.StrCmp(control2.Text, "", false) != 0 & control3.SelectedIndex != -1)
        {
          ComboBox control4 = (ComboBox) FindControl("co" + StringType.FromInteger(num3));
          RF.FilterParts.Add(new RowFilterPart(((ColumnEntry) control1.SelectedItem).NativeColName, ((ColumnEntry) control1.SelectedItem).DisplayColName, StringType.FromObject(control3.SelectedItem), control2.Text, StringType.FromObject(control4.SelectedItem), ((ColumnEntry) control1.SelectedItem).DataType.Name));
        }
        checked { ++num3; }
      }
    ...
    private void btnReset_Click(object sender, EventArgs e)
    {
      ...
      while (num3 <= num2)
      {
        ((ComboBox) FindControl("cn" + StringType.FromInteger(num3))).SelectedIndex = -1;
        ((ComboBox) FindControl("mo" + StringType.FromInteger(num3))).SelectedIndex = -1;
        ((ComboBox) FindControl("co" + StringType.FromInteger(num3))).SelectedIndex = 0;
        ((TextBox) FindControl("cr" + StringType.FromInteger(num3))).Text = "";
        checked { ++num3; }
      }
      m_HandlersActive = true;
    }
    ...
    private void BuildGuiFromRowFilterList()
    {
      ...
      {
        int num1 = 1;
        int num2 = checked (RF.FilterParts.Count - 1);
        int num3 = num1;
        while (num3 <= num2)
        {
          AddFilterRow();
      ...
      while (num5 <= count)
      {
        ComboBox control1 = (ComboBox) FindControl("cn" + StringType.FromInteger(num5));
        ComboBox control2 = (ComboBox) FindControl("mo" + StringType.FromInteger(num5));
        TextBox control3 = (TextBox) FindControl("cr" + StringType.FromInteger(num5));
        ComboBox control4 = (ComboBox) FindControl("co" + StringType.FromInteger(num5));
        RowFilterPart filterPart = (RowFilterPart) RF.FilterParts[checked (num5 - 1)];
    ...
    private void AddFilterRow()
    {
      ...
      comboBox1.SelectedIndexChanged += cmbxColumnName_SelectedIndexChanged;
      ...
      comboBox5.SelectedIndexChanged += cmbxConcatOperator_SelectedIndexChanged;
    ...
    private void MoveControlsUp(int startControlInstanceNum)
    {
      ...
      while (num3 <= num2)
      {
        ...
        Point location1 = new Point(10,10);
        // ISSUE: explicit reference operation
        // ISSUE: variable of a reference type
        Point local1 = @location1;
    ...
    {
      RemoveFilterRow(IntegerType.FromString(Strings.Mid(StringType.FromObject(((Control) sender).Tag), 3)));
    }
    ...
    {
      Type dataType = ((ColumnEntry) BrotherColNameCB.SelectedItem).DataType;
    ...
    private void frmFilterDesigner_Load(object sender, EventArgs e)
    {
      ...
      cmbxColumnName1.SelectedIndexChanged += cmbxColumnName_SelectedIndexChanged;
      cmbxConcatOperator1.SelectedIndexChanged += cmbxConcatOperator_SelectedIndexChanged;
