...
// Type: KotorTool_2.frmResourceTypeSelector
...
namespace KotorTool_2._0.Ui.Forms
{
  public class frmResourceTypeSelector : Form
  {
    ...
    [AccessedThroughProperty("chkbNCS")]
    private CheckBox _chkbNCS;
    [AccessedThroughProperty("btnOK")]
    private Button _btnOK;
    [AccessedThroughProperty("chkbUTP")]
    private CheckBox _chkbUTP;
    [AccessedThroughProperty("chkbUTS")]
    private CheckBox _chkbUTS;
    [AccessedThroughProperty("chkbUTE")]
    private CheckBox _chkbUTE;
    [AccessedThroughProperty("chkbUTW")]
    private CheckBox _chkbUTW;
    [AccessedThroughProperty("chkbPTH")]
    private CheckBox _chkbPTH;
    [AccessedThroughProperty("chkbGIT")]
    private CheckBox _chkbGIT;
    [AccessedThroughProperty("chkbUTC")]
    private CheckBox _chkbUTC;
    [AccessedThroughProperty("chkbARE")]
    private CheckBox _chkbARE;
    [AccessedThroughProperty("chkbUTT")]
    private CheckBox _chkbUTT;
    [AccessedThroughProperty("chkbIFO")]
    private CheckBox _chkbIFO;
    [AccessedThroughProperty("Label1")]
    private Label _Label1;
    [AccessedThroughProperty("chkbUTM")]
    private CheckBox _chkbUTM;
    [AccessedThroughProperty("chkbUTD")]
    private CheckBox _chkbUTD;
    ...
    public frmResourceTypeSelector()
    {
      InitializeComponent();
    }
