...
// Type: KotorTool_2.frmUTC_Editor
...
using KotorTool_2._0.Ui.InventoryEditor;
...
namespace KotorTool_2._0.Ui.Forms
{
  public class frmUTC_Editor : frmParent
  {
    ...
    internal virtual TrackBar trkbarAlignment
    {
      ...
      [MethodImpl(MethodImplOptions.Synchronized)] set
      {
        if (_trkbarAlignment != null)
          _trkbarAlignment.Scroll -= trkbarAlignment_Scroll;
    ...
    internal virtual NumericUpDown nudAlignment
    {
      ...
      [MethodImpl(MethodImplOptions.Synchronized)] set
      {
        if (_nudAlignment != null)
          _nudAlignment.ValueChanged -= nudAlignment_ValueChanged;
        _nudAlignment = value;
        if (_nudAlignment == null)
          return;
        _nudAlignment.ValueChanged += nudAlignment_ValueChanged;
    ...
    internal virtual CheckedListBox chklbFeats
    {
      ...
      {
        if (_chklbFeats != null)
          _chklbFeats.MouseMove -= chklbFeats_MouseMove;
        _chklbFeats = value;
        if (_chklbFeats == null)
          return;
        _chklbFeats.MouseMove += chklbFeats_MouseMove;
    ...
    internal virtual CheckedListBox chklbForcePowers
    {
      ...
      [MethodImpl(MethodImplOptions.Synchronized)] set
      {
        if (_chklbForcePowers != null)
          _chklbForcePowers.MouseMove -= chklbForcePowers_MouseMove;
    ...
    internal virtual Button btnWriteFile
    {
      ...
      [MethodImpl(MethodImplOptions.Synchronized)] set
      {
        if (_btnWriteFile != null)
          _btnWriteFile.Click -= btnWriteFile_Click;
        _btnWriteFile = value;
        if (_btnWriteFile == null)
          return;
        _btnWriteFile.Click += btnWriteFile_Click;
    ...
    internal virtual Button btnClearAllPowers
    {
      ...
      [MethodImpl(MethodImplOptions.Synchronized)] set
      {
        if (_btnClearAllPowers != null)
          _btnClearAllPowers.Click -= btnClearAllPowers_Click;
    ...
    internal virtual Button btnSelectAllPowers
    {
      ...
      [MethodImpl(MethodImplOptions.Synchronized)] set
      {
        if (_btnSelectAllPowers != null)
          _btnSelectAllPowers.Click -= btnSelectAllPowers_Click;
    ...
    internal virtual Button btnEditOnEndDialogu
    {
      ...
      [MethodImpl(MethodImplOptions.Synchronized)] set
      {
        if (_btnEditOnEndDialogu != null)
          _btnEditOnEndDialogu.Click -= btnEditScript_Click;
    ...
    internal virtual Button btnEditOnDialogue
    {
      ...
      [MethodImpl(MethodImplOptions.Synchronized)] set
      {
        if (_btnEditOnDialogue != null)
          _btnEditOnDialogue.Click -= btnEditScript_Click;
    ...
    internal virtual Button btnEditOnUserDefine
    {
      ...
      [MethodImpl(MethodImplOptions.Synchronized)] set
      {
        if (_btnEditOnUserDefine != null)
          _btnEditOnUserDefine.Click -= btnEditScript_Click;
    ...
    internal virtual Button btnEditOnDisturbed
    {
      ...
      [MethodImpl(MethodImplOptions.Synchronized)] set
      {
        if (_btnEditOnDisturbed != null)
          _btnEditOnDisturbed.Click -= btnEditScript_Click;
    ...
    internal virtual Button btnEditOnAttacked
    {
      ...
      [MethodImpl(MethodImplOptions.Synchronized)] set
      {
        if (_btnEditOnAttacked != null)
          _btnEditOnAttacked.Click -= btnEditScript_Click;
    ...
    internal virtual Button btnEditOnNotice
    {
      ...
      [MethodImpl(MethodImplOptions.Synchronized)] set
      {
        if (_btnEditOnNotice != null)
          _btnEditOnNotice.Click -= btnEditScript_Click;
    ...
    internal virtual Button btnEditOnSpellAt
    {
      ...
      [MethodImpl(MethodImplOptions.Synchronized)] set
      {
        if (_btnEditOnSpellAt != null)
          _btnEditOnSpellAt.Click -= btnEditScript_Click;
    ...
    internal virtual Button btnEditOnSpawn
    {
      ...
      [MethodImpl(MethodImplOptions.Synchronized)] set
      {
        if (_btnEditOnSpawn != null)
          _btnEditOnSpawn.Click -= btnEditScript_Click;
    ...
    internal virtual Button btnEditOnBlocked
    {
      ...
      [MethodImpl(MethodImplOptions.Synchronized)] set
      {
        if (_btnEditOnBlocked != null)
          _btnEditOnBlocked.Click -= btnEditScript_Click;
    ...
    internal virtual Button btnEditOnRested
    {
      ...
      [MethodImpl(MethodImplOptions.Synchronized)] set
      {
        if (_btnEditOnRested != null)
          _btnEditOnRested.Click -= btnEditScript_Click;
    ...
    internal virtual Button btnEditOnEndRound
    {
      ...
      [MethodImpl(MethodImplOptions.Synchronized)] set
      {
        if (_btnEditOnEndRound != null)
          _btnEditOnEndRound.Click -= btnEditScript_Click;
    ...
    {
      Load += frmUTC_Editor_Load;
      Closing += frmUTC_Editor_Closing;
    ...
    public frmUTC_Editor(ClsUtc UTCClass, int KotorVerIndex, bool IsDirectEdit = false, string EditingPath = "")
      : this()
    {
      if (IsDirectEdit)
      {
      ...
      m_defaultTitleText = "Creature Editor - KotOR ";
    ...
    private void InitializeComponent()
    {
      ...
      Decimal num1 = new Decimal(new int[4]{ 250, 0, 0, 0 });
      Decimal num2 = num1;
    ...
    public void Setup()
    {
      ChitinKeyProvider clsChitinKey = new ChitinKeyProvider(ConfigOptions.Paths.KeyFileLocation(KotorVersionIndex));
      ...
      FillChkListBoxFrom2DA(chklbFeats, "name", "feat", clsChitinKey, g_clsDialogTlk);
      int num1 = 0;
      int num2 = checked (UTC.GetListItemCount("FeatList") - 1);
      int num3 = num1;
      while (num3 <= num2)
      {
        chklbFeats.SetItemChecked(Convert.ToInt32(RuntimeHelpers.GetObjectValue(UTC.GetNodeValue("FeatList(" + StringType.FromInteger(num3) + ").Feat"))), true);
        checked { ++num3; }
      }
      FillSpecialAbilitiesChkListBoxFrom2DA(chklbSpecialAbilities, clsChitinKey, g_clsDialogTlk);
      UTC.SetNumericUpDownToNodeValue(nudForcePoints, "ForcePoints");
      UTC.SetNumericUpDownToNodeValue(nudCurrentForce, "CurrentForce");
      FillSpellsChkListBoxFrom2DA(chklbForcePowers, clsChitinKey, g_clsDialogTlk);
      Cls2Da cls2Da = ReadCls2DA("spells", clsChitinKey);
      int num4 = 0;
      int num5 = checked (UTC.GetListItemCount("ClassList(0).KnownList0") - 1);
      int num6 = num4;
      while (num6 <= num5)
      {
        int int32 = Convert.ToInt32(RuntimeHelpers.GetObjectValue(UTC.GetNodeValue("ClassList(0).KnownList0(" + StringType.FromInteger(num6) + ").Spell")));
    ...
    private object BuildComboBoxes(ChitinKeyProvider clsChitin)
    {
      ...
      FillComboBoxFrom2DA(cmbxFaction, "label", "repute", clsChitin, null);
      if (!UTC.SyncComboBox(cmbxFaction, "FactionID"))
        ComboBoxSettingError = true;
      FillComboBoxFrom2DA(cmbxBodyBag, "label", "bodybag", clsChitin, null);
      if (!UTC.SyncComboBox(cmbxBodyBag, "BodyBag"))
        ComboBoxSettingError = true;
      FillComboBoxFrom2DA(cmbxGender, "name", "gender", clsChitin, g_clsDialogTlk);
      if (!UTC.SyncComboBox(cmbxGender, "Gender"))
        ComboBoxSettingError = true;
      FillComboBoxFrom2DA(cmbxRace, "name", "racialtypes", clsChitin, g_clsDialogTlk);
      if (!UTC.SyncComboBox(cmbxRace, "Race"))
        ComboBoxSettingError = true;
      FillComboBoxFrom2DA(cmbxPhenotype, "label", "phenotype", clsChitin, null);
      if (!UTC.SyncComboBox(cmbxPhenotype, "Phenotype"))
        ComboBoxSettingError = true;
      FillComboBoxFrom2DA(cmbxMovementRate, "label", "creaturespeed", clsChitin, null);
      ...
      if (UTC.VerifyNodeExists("MovementRate") && !UTC.SyncComboBox(cmbxMovementRate, "MovementRate"))
        ComboBoxSettingError = true;
      FillComboBoxFrom2DA(cmbxClass, "name", "classes", clsChitin, g_clsDialogTlk);
      if (!UTC.SyncComboBox(cmbxClass, "ClassList(0).Class"))
        ComboBoxSettingError = true;
      FillComboBoxFrom2DA(cmbxSubrace, "label", "subrace", clsChitin, null);
      if (!UTC.SyncComboBox(cmbxSubrace, "SubraceIndex"))
        ComboBoxSettingError = true;
      FillComboBoxFrom2DA(cmbxSoundSet, "label", "soundset", clsChitin, g_clsDialogTlk);
      if (Convert.ToInt32(RuntimeHelpers.GetObjectValue(UTC.GetNodeValue("SoundSetFile"))) == ushort.MaxValue)
        ...
        ComboBoxSettingError = true;
      FillComboBoxFrom2DA(cmbxPortrait, "baseresref", "portraits", clsChitin, null);
    ...
    private void FillChkListBoxFrom2DA(CheckedListBox lbx, string colName, string TwoDAName, ChitinKeyProvider ChitinKey, ClsDialogTlk DialogTlk)
    {
      Cls2Da cls2Da = ReadCls2DA(TwoDAName, ChitinKey);
      if (DialogTlk != null)
      {
    ...
    private void FillSpellsChkListBoxFrom2DA(CheckedListBox lbx, ChitinKeyProvider ChitinKey, ClsDialogTlk DialogTlk)
    {
    ...
    private void FillSpecialAbilitiesChkListBoxFrom2DA(CheckedListBox lbx, ChitinKeyProvider ChitinKey, ClsDialogTlk DialogTlk)
    {
      ...
      while (num2 <= rowsUpperBound)
      {
        ...
        if (Information.IsNumeric(RuntimeHelpers.GetObjectValue(indiceData1)) && ObjectType.ObjTst(indiceData1, 2, false) == 0)
        {
          ...
          if (StringType.StrCmp(str, "****", false) != 0)
            arrayList.Add(new ComboBoxListItem(num2, str));
        }
        checked { ++num2; }
      }
    ...
    private void trkbarAlignment_Scroll(object sender, EventArgs e)
    {
      nudAlignment.Value = new Decimal(((TrackBar) sender).Value);
    }

    private void nudAlignment_ValueChanged(object sender, EventArgs e)
    {
      trkbarAlignment.Value = Convert.ToInt32(((NumericUpDown) sender).Value);
    }
    ...
    private void SetGFFNodeValues()
    {
      ...
      UTC.ClearListElements("FeatList");
        ...
        {
          int num = IntegerType.FromObject(checkedIndex);
          GffStruct @struct = new GffStruct();
          @struct.Type = 1;
          @struct.FieldCount = 1;
          @struct.Fields = new GffField[1];
          @struct.Fields[0] = new GffField(GffFieldTypes.GffWord, "Feat", num);
      ...
      UTC.ClearListElements("ClassList(0).KnownList0");
        ...
        foreach (object checkedIndex in chklbForcePowers.CheckedIndices)
        {
          ...
          @struct.Type = 3;
          @struct.FieldCount = 3;
          @struct.Fields = new GffField[3];
          int num = IntegerType.FromObject(g_ForcePowerList[index]);
          @struct.Fields[0] = new GffField(GffFieldTypes.GffWord, "Spell", num);
          @struct.Fields[1] = new GffField(GffFieldTypes.GffByte, "SpellMetaMagic", 0);
          @struct.Fields[2] = new GffField(GffFieldTypes.GffByte, "SpellFlags", 1);
      ...
      if (KotorVersionIndex == 1)
      {
        if (!UTC.VerifyNodeExists("BlindSpot"))
          UTC.AddSimpleField("BlindSpot", GffFieldTypes.GffFloat, nudBlindSpot.Value);
        else
          UTC.SetNodeValueFromNumericUpDown(nudBlindSpot, "BlindSpot");
        if (!UTC.VerifyNodeExists("MultiplierSet"))
          UTC.AddSimpleField("MultiplierSet", GffFieldTypes.GffByte, nudMultiplierSet.Value);
        else
          UTC.SetNodeValueFromNumericUpDown(nudMultiplierSet, "MultiplierSet");
        if (!UTC.VerifyNodeExists("IgnoreCrePath"))
          UTC.AddSimpleField("IgnoreCrePath", GffFieldTypes.GffByte, chkbIgnoreCrePath.Checked);
        else
          UTC.SetNodeValue("IgnoreCrePath", chkbIgnoreCrePath.Checked);
        if (!UTC.VerifyNodeExists("Hologram"))
          UTC.AddSimpleField("Hologram", GffFieldTypes.GffByte, chkbIsHologram.Checked);
        else
          UTC.SetNodeValue("Hologram", chkbIsHologram.Checked);
        if (!UTC.VerifyNodeExists("NotReorienting"))
          UTC.AddSimpleField("NotReorienting", GffFieldTypes.GffByte, chkbNotReorienting.Checked);
        else
    ...
    private void SetNodeValueFromNumericUpDown(NumericUpDown NUD, string NodePath)
    {
      UTC.SetNodeValue(NodePath, NUD.Value);
    }

    private void SetNodeValueFromTextBox(TextBox TB, string NodePath)
    {
      UTC.SetNodeValue(NodePath, TB.Text);
    }

    private void SetNodeValueFromComboBox(ComboBox cmbx, string NodePath)
    {
      UTC.SetNodeValue(NodePath, cmbx.SelectedIndex);
    }

    private void SetPerceptionRangeNodeValueFromComboBox()
    {
      UTC.SetNodeValue("PerceptionRange", checked (cmbxPerceptionRange.SelectedIndex + 9));
    }
    ...
    private void btnWriteFile_Click(object sender, EventArgs e)
    {
      ...
      UTC.WriteFile(m_EditingFilePath, "UTC");
      if (!m_bSaveGameMode)
        return;
      Close();
    }
    ...
    private void Button2_Click(object sender, EventArgs e)
    {
      ...
      @struct.FieldCount = 3;
      @struct.Fields = new GffField[3];
      @struct.Fields[0] = new GffField(GffFieldTypes.GffWord, "Spell", 99);
      @struct.Fields[1] = new GffField(GffFieldTypes.GffByte, "SpellMetaMagic", 1);
      @struct.Fields[2] = new GffField(GffFieldTypes.GffByte, "SpellFlags", 2);
      UTC.AddListElement("ClassList(0).KnownList0", @struct);
    }
    ...
    private void btnInventory_Click(object sender, EventArgs e)
    {
      ...
      int num1 = 0;
      int num2 = checked (UTC.GetListItemCount("ItemList") - 1);
      int num3 = num1;
      while (num3 <= num2)
      {
        string ResRef = StringType.FromObject(UTC.GetNodeValue("ItemList(" + StringType.FromInteger(num3) + ").InventoryRes"));
        bool Dropable = !UTC.VerifyNodeExists("ItemList(" + StringType.FromInteger(num3) + ").Dropable") || ObjectType.ObjTst(UTC.GetNodeValue("ItemList(" + StringType.FromInteger(num3) + ").Dropable"), 1, false) == 0;
        frmInventoryEditor.AddPackItem(ResRef, Dropable);
        checked { ++num3; }
      }
      int num4 = 0;
      int num5 = checked (UTC.GetListItemCount("Equip_ItemList") - 1);
      int num6 = num4;
      while (num6 <= num5)
      {
        string ResRef = StringType.FromObject(UTC.GetNodeValue("Equip_ItemList(" + StringType.FromInteger(num6) + ").EquippedRes"));
        int structFieldType = UTC.GetStructFieldType("Equip_ItemList(" + StringType.FromInteger(num6) + ")");
        bool Dropable = !UTC.VerifyNodeExists("Equip_ItemList(" + StringType.FromInteger(num6) + ").Dropable") || ObjectType.ObjTst(UTC.GetNodeValue("Equip_ItemList(" + StringType.FromInteger(num6) + ").Dropable"), 1, false) == 0;
    ...
    {
      int num1 = 0;
      int num2 = checked (chklbForcePowers.Items.Count - 1);
      int index = num1;
      while (index <= num2)
      {
    ...
    private void frmUTC_Editor_Load(object sender, EventArgs e)
    {
