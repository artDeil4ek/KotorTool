...
// Type: KotorTool_2.frmUTD_Editor
...
namespace KotorTool_2._0.Ui.Forms
{
  public class frmUTD_Editor : frmParent
  {
    ...
    internal virtual Button btnEditOnFailToOpen
    {
      ...
      [MethodImpl(MethodImplOptions.Synchronized)] set
      {
        if (_btnEditOnFailToOpen != null)
          _btnEditOnFailToOpen.Click -= btnEditScript_Click;
    ...
    {
      Load += frmUTD_Editor_Load;
      Closing += frmUTD_Editor_Closing;
      ComboBoxSettingError = false;
      m_bSaveGameMode = false;
      InitializeComponent();
    }

    public frmUTD_Editor(ClsUtd UTDClass, int KotorVerIndex, bool IsDirectEdit = false, string EditingPath = "")
      : this()
    {
      if (IsDirectEdit)
      {
      ...
      m_defaultTitleText = "Door Editor - KotOR ";
    ...
    private void BuildComboBoxes()
    {
      ...
      FillComboBoxFrom2DA(cmbxFaction, "label", "repute", g_clsChitinKey, null);
    ...
    private void btnSave_Click(object sender, EventArgs e)
    {
      ...
      UTD.WriteFile(m_EditingFilePath, "UTD");
      if (!m_bSaveGameMode)
        return;
      Close();
    }
    ...
    private void frmUTD_Editor_Load(object sender, EventArgs e)
    {
