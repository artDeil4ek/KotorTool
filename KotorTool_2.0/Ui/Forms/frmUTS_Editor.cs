...
// Type: KotorTool_2.frmUTS_Editor
...
using KotorTool_2._0.Ui.SoundChooser;
  ...
  public class frmUTS_Editor : frmParent
  {
    ...
    internal virtual ListBox lbSounds
    {
      ...
      [MethodImpl(MethodImplOptions.Synchronized)] set
      {
        if (_lbSounds != null)
        {
          _lbSounds.SelectedIndexChanged -= lbSounds_SelectedIndexChanged;
          _lbSounds.DoubleClick -= lbSounds_DoubleClick;
        }
        _lbSounds = value;
        if (_lbSounds == null)
          return;
    ...
    internal virtual RadioButton rbPlaysEverywhere
    {
      ...
      [MethodImpl(MethodImplOptions.Synchronized)] set
      {
        if (_rbPlaysEverywhere != null)
          _rbPlaysEverywhere.CheckedChanged -= rbPlaysWhere_CheckedChanged;
    ...
    internal virtual RadioButton rbRandomPosition
    {
      ...
      [MethodImpl(MethodImplOptions.Synchronized)] set
      {
        if (_rbRandomPosition != null)
          _rbRandomPosition.CheckedChanged -= rbPlaysWhere_CheckedChanged;
    ...
    internal virtual RadioButton rbSpecificPosition
    {
      ...
      [MethodImpl(MethodImplOptions.Synchronized)] set
      {
        if (_rbSpecificPosition != null)
          _rbSpecificPosition.CheckedChanged -= rbPlaysWhere_CheckedChanged;
    ...
    internal virtual RadioButton rbPlayDay
    {
      ...
      {
        if (_rbPlayDay != null)
          _rbPlayDay.CheckedChanged -= rbPlayDay_CheckedChanged;
        _rbPlayDay = value;
        if (_rbPlayDay == null)
          return;
        _rbPlayDay.CheckedChanged += rbPlayDay_CheckedChanged;
    ...
    internal virtual RadioButton rbPlayNight
    {
      ...
      [MethodImpl(MethodImplOptions.Synchronized)] set
      {
        if (_rbPlayNight != null)
          _rbPlayNight.CheckedChanged -= rbPlayDay_CheckedChanged;
        _rbPlayNight = value;
        if (_rbPlayNight == null)
          return;
        _rbPlayNight.CheckedChanged += rbPlayDay_CheckedChanged;
    ...
    internal virtual RadioButton rbPlayAllTimes
    {
      ...
      [MethodImpl(MethodImplOptions.Synchronized)] set
      {
        if (_rbPlayAllTimes != null)
          _rbPlayAllTimes.CheckedChanged -= rbPlayDay_CheckedChanged;
    ...
    internal virtual RadioButton rbPlaySpecificHours
    {
      ...
      [MethodImpl(MethodImplOptions.Synchronized)] set
      {
        if (_rbPlaySpecificHours != null)
          _rbPlaySpecificHours.CheckedChanged -= rbPlayDay_CheckedChanged;
    ...
    internal virtual TrackBar trkbarVolumeVrtn
    {
      ...
      [MethodImpl(MethodImplOptions.Synchronized)] set
      {
        if (_trkbarVolumeVrtn != null)
          _trkbarVolumeVrtn.ValueChanged -= trkbarVolumeVrtn_ValueChanged;
    ...
    internal virtual RadioButton rbOnce
    {
      ...
      {
        if (_rbOnce != null)
          _rbOnce.CheckedChanged -= rbLooping_CheckedChanged;
        _rbOnce = value;
        if (_rbOnce == null)
          return;
        _rbOnce.CheckedChanged += rbLooping_CheckedChanged;
    ...
    internal virtual RadioButton rbRepeating
    {
      ...
      [MethodImpl(MethodImplOptions.Synchronized)] set
      {
        if (_rbRepeating != null)
          _rbRepeating.CheckedChanged -= rbLooping_CheckedChanged;
        _rbRepeating = value;
        if (_rbRepeating == null)
          return;
        _rbRepeating.CheckedChanged += rbLooping_CheckedChanged;
    ...
    internal virtual TrackBar trkbarPitchVrtn
    {
      ...
      [MethodImpl(MethodImplOptions.Synchronized)] set
      {
        if (_trkbarPitchVrtn != null)
          _trkbarPitchVrtn.ValueChanged -= trkbarPitchVrtn_ValueChanged;
    ...
    internal virtual RadioButton rbLooping
    {
      ...
      {
        if (_rbLooping != null)
          _rbLooping.CheckedChanged -= rbLooping_CheckedChanged;
        _rbLooping = value;
        if (_rbLooping == null)
          return;
        _rbLooping.CheckedChanged += rbLooping_CheckedChanged;
    ...
    internal virtual Button btnAddSound
    {
      ...
      [MethodImpl(MethodImplOptions.Synchronized)] set
      {
        if (_btnAddSound != null)
          _btnAddSound.Click -= btnAddSound_Click;
        _btnAddSound = value;
        if (_btnAddSound == null)
          return;
        _btnAddSound.Click += btnAddSound_Click;
    ...
    internal virtual Button btnRemoveSound
    {
      ...
      [MethodImpl(MethodImplOptions.Synchronized)] set
      {
        if (_btnRemoveSound != null)
          _btnRemoveSound.Click -= btnRemoveSound_Click;
    ...
    internal virtual TrackBar trkbarVolume
    {
      ...
      [MethodImpl(MethodImplOptions.Synchronized)] set
      {
        if (_trkbarVolume != null)
          _trkbarVolume.ValueChanged -= trkbarVolume_ValueChanged;
        _trkbarVolume = value;
        if (_trkbarVolume == null)
          return;
        _trkbarVolume.ValueChanged += trkbarVolume_ValueChanged;
    ...
    internal virtual Button btnPlaySound
    {
      ...
      [MethodImpl(MethodImplOptions.Synchronized)] set
      {
        if (_btnPlaySound != null)
          _btnPlaySound.Click -= btnPlaySound_Click;
        _btnPlaySound = value;
        if (_btnPlaySound == null)
          return;
        _btnPlaySound.Click += btnPlaySound_Click;
    ...
    internal virtual Button btnStopSound
    {
      ...
      [MethodImpl(MethodImplOptions.Synchronized)] set
      {
        if (_btnStopSound != null)
          _btnStopSound.Click -= btnStopSound_Click;
        _btnStopSound = value;
        if (_btnStopSound == null)
          return;
        _btnStopSound.Click += btnStopSound_Click;
    ...
    {
      Load += frmUTS_Editor_Load;
      Closing += frmUTS_Editor_Closing;
    ...
    public frmUTS_Editor(ClsUts UTSClass, int KotorVerIndex, bool IsDirectEdit = false, string EditingPath = "")
      : this()
    {
      if (IsDirectEdit)
      {
      ...
      m_defaultTitleText = "Sound Editor - KotOR ";
      ...
      Setup();
      result = Factory.System_Create(out fmSystem);
      result = fmSystem.getVersion(out FMODversion);
      if (Convert.ToInt32(FMODversion) < Convert.ToInt32(262405))
      {
        MessageBox.Show("Error!  You are using an old version of FMOD " + FMODversion.ToString("X") + ".  This program requires " + 262405.ToString("X") + ".");
      }
      result = fmSystem.init(32, INITFLAGS.NORMAL, (IntPtr) (null ?? Activator.CreateInstance(typeof (IntPtr))));
      htBIFSounds = ChitinKey.KxChitinKey(KotorVersionIndex).GetBiffFileHash("sounds");
    ...
    protected override void Dispose(bool disposing)
    {
     ...
     #region MyRegion
      ...
      private void InitializeComponent()
      {
          ...
          Decimal num1 = new Decimal(new int[4]{ 100, 0, 0, int.MinValue });
          Decimal num2 = num1;
    ...
    private void Setup()
    {
      ...
      int num1 = 0;
      int num2 = checked(UTS.GetListItemCount("Sounds") - 1);
      int num3 = num1;
      while (num3 <= num2)
      {
        lbSounds.Items.Add(RuntimeHelpers.GetObjectValue(UTS.GetNodeValue("Sounds(" + StringType.FromInteger(num3) + ").Sound")));
        ++num3;
      }
      ...
      if (!(flag1 | flag2)) rbPlaysEverywhere.Checked = true;
      else if (flag1 & flag2) rbRandomPosition.Checked = true;
      else rbSpecificPosition.Checked = true;
      ...
      if (ObjectType.ObjTst(nodeValue, 1, false) == 0) rbPlayDay.Checked = true;
      else if (ObjectType.ObjTst(nodeValue, 2, false) == 0) rbPlayNight.Checked = true;
      else if (ObjectType.ObjTst(nodeValue, 3, false) == 0) rbPlayAllTimes.Checked = true;
      else if (ObjectType.ObjTst(nodeValue, 0, false) == 0)
      {
        ...
        {
          if (StringType.StrCmp(control.GetType().Name, "CheckBox", false) == 0 && ((ulong) int32 & (ulong) checked((long) Math.Round(Math.Pow(2.0, Convert.ToInt32(RuntimeHelpers.GetObjectValue(control.Tag)))))) > 0UL) ((CheckBox) control).Checked = true;
        }
    ...
    private void SetGFFNodeValues()
    {
      ...
      int num1 = 0;
      int num2 = lbSounds.Items.Count - 1;
      int index = num1;
      while (index <= num2)
      {
        GffStruct @struct = new GffStruct(1, 0);
        @struct.Fields[0] = new GffField(GffFieldTypes.GffCResRef, "Sound", RuntimeHelpers.GetObjectValue(lbSounds.Items[index]));
      ...
      if (rbPlayDay.Checked) UTS.SetNodeValue("Times", 1);
      else if (rbPlayNight.Checked) UTS.SetNodeValue("Times", 2);
        ...
        int num3 = 0;
          ...
          foreach (Control control in pnlHours.Controls)
          {
            if (StringType.StrCmp(control.GetType().Name, "CheckBox", false) == 0 && ((CheckBox) control).Checked)
              num3 = checked ((int) (num3 | (long) Math.Round(Math.Pow(2.0, Convert.ToInt32(RuntimeHelpers.GetObjectValue(control.Tag))))));
          }
       
        UTS.SetNodeValue("Hours", num3);
      }
    ...
    private void btnAddSound_Click(object sender, EventArgs e)
    {
      ...
      frmSoundChooser.ShowDialog(this);
      if (frmSoundChooser.DialogResult == DialogResult.OK)
      {
          ...
          foreach (object selectedSound in frmSoundChooser.SelectedSounds)
          {
            ...
            if (str.Length > 16)
            {
             Interaction.MsgBox("The sound \"" + str + "\"" + " must be renamed to be no more than 16 characters long, not including the extension, to be used." + "\n" + "\n" + "The sound will not be added.", MsgBoxStyle.Critical, "ResRef too long");
            }
            else
    ...
    {
      int selectedIndex = this.lbSounds.SelectedIndex;
      if (selectedIndex <= 0)
        return;
      string str = StringType.FromObject(this.lbSounds.SelectedItem);
      this.lbSounds.Items[selectedIndex] = RuntimeHelpers.GetObjectValue(this.lbSounds.Items[checked (selectedIndex - 1)]);
      this.lbSounds.Items[checked (selectedIndex - 1)] = str;
      ListBox lbSounds = this.lbSounds;
      lbSounds.SelectedIndex = checked (lbSounds.SelectedIndex - 1);
    }

    private void btnMoveDown_Click(object sender, EventArgs e)
    {
      int selectedIndex = this.lbSounds.SelectedIndex;
      if (selectedIndex >= checked (this.lbSounds.Items.Count - 1))
        return;
      string str = StringType.FromObject(this.lbSounds.SelectedItem);
      this.lbSounds.Items[selectedIndex] = RuntimeHelpers.GetObjectValue(this.lbSounds.Items[checked (selectedIndex + 1)]);
      this.lbSounds.Items[checked (selectedIndex + 1)] = str;
    ...
    private void btnSave_Click(object sender, EventArgs e)
    {
      ...
      UTS.WriteFile(m_EditingFilePath, "UTS");
      if (!m_bSaveGameMode)
        return;
      Close();
    }
    ...
    private void lbSounds_SelectedIndexChanged(object sender, EventArgs e)
    {
      ...
      {
        IsItemSelected = true;
        if (!IsSoundPlaying()) btnPlaySound.Enabled = true;
        ...
        {
          if (lbSounds.SelectedIndices.Count != 1) return;
    ...
    {
      if (!(lbSounds.SelectedIndex != -1 & !IsSoundPlaying())) return;
    ...
    private void rbPlayDay_CheckedChanged(object sender, EventArgs e)
    {
      pnlHours.Enabled = rbPlaySpecificHours.Checked;
    }
    ...
    private void frmUTS_Editor_Load(object sender, EventArgs e)
    {
    ...
    private void trkbarVolumeVrtn_ValueChanged(object sender, EventArgs e)
    {
      tbVolumeVrtn.Text = StringType.FromInteger(trkbarVolumeVrtn.Value);
    }

    private void trkbarPitchVrtn_ValueChanged(object sender, EventArgs e)
    {
      tbPitchVrtn.Text = StringType.FromDouble(trkbarPitchVrtn.Value / 100.0);
    }

    private void trkbarVolume_ValueChanged(object sender, EventArgs e)
    {
      tbVolume.Text = StringType.FromInteger(trkbarVolume.Value);
    }
    ...
    private void Timer1_Tick(object sender, EventArgs e)
    {
      ...
      {
      /*  uint position = 0;
        this.result = this.channel.getPosition(out position, TIMEUNIT.MS);
        FMOD.Sound sound = new FMOD.Sound(out position);
        int currentSound = (int) this.channel.getCurrentSound(out sound);
        uint length = 0;
        if (sound != null)
        {
          this.result = sound.getLength(out length, TIMEUNIT.MS);
          if (this.result != RESULT.OK && this.result != RESULT.ERR_INVALID_HANDLE && this.result != RESULT.ERR_CHANNEL_STOLEN)
            this.ERRCHECK(this.result);
        }
        int int32_1 = Convert.ToInt32(length);
        int int32_2 = Convert.ToInt32(position);
        this.tbSoundStatus.Text = (checked ((long) Math.Round(unchecked ((double) int32_2 / 1000.0))) / 60L).ToString().PadLeft(2, '0') + ":" + Conversion.Int((double) int32_2 / 1000.0 % 60.0).ToString().PadLeft(2, '0') + ":" + Conversion.Int((double) int32_2 / 10.0 % 100.0).ToString().PadLeft(2, '0') + "/" + (checked ((long) Math.Round(unchecked ((double) int32_1 / 1000.0))) / 60L).ToString().PadLeft(2, '0') + ":" + Conversion.Int((double) int32_1 / 1000.0 % 60.0).ToString().PadLeft(2, '0') + ":" + Conversion.Int((double) int32_1 / 10.0 % 100.0).ToString().PadLeft(2, '0');
    */
      }
      else
      {
    ...
    public bool PlaySound(string filename)
    {
      ...
      if (!flag)
      {
        KtSoundInfo kotorSoundInfo = KtSoundInfo.GetKotorSoundInfo(filename);
      ...
      result = fmSystem.createSound(filename, MODE._2D | MODE.VIRTUAL_PLAYFROMSTART | MODE.CREATESTREAM | MODE.MPEGSEARCH, ref exinfo, out sound1);
      //this.result = this.fmSystem.playSound(this.sound1, new FMOD.ChannelGroup(,  false, out this.channel);
      Timer1.Enabled = true;
      return true;
    }
    ...
    public bool IsSoundPlaying()
    {
      ...
      if (channel != null) result = channel.isPlaying(out isplaying);
      return isplaying;
    }
