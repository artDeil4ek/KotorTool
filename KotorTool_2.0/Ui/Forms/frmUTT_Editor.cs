...
// Type: KotorTool_2.frmUTT_Editor
...
namespace KotorTool_2._0.Ui.Forms
{
    public class frmUTT_Editor : frmParent
    {
        ...
        [AccessedThroughProperty("cmbxType")] private ComboBox _cmbxType;
        ...
        [AccessedThroughProperty("tbKeyName")] private TextBox _tbKeyName;

        [AccessedThroughProperty("cmbxFaction")]
        private ComboBox _cmbxFaction;

        [AccessedThroughProperty("tbCursor")] private TextBox _tbCursor;
        ...
        [AccessedThroughProperty("tbOnClick")] private TextBox _tbOnClick;
        ...
        internal virtual ComboBox cmbxType
        {
            ...
            {
                if (_cmbxType != null)
                    _cmbxType.SelectedIndexChanged -= cmbxType_SelectedIndexChanged;
                _cmbxType = value;
                if (_cmbxType == null)
                    return;
                _cmbxType.SelectedIndexChanged += cmbxType_SelectedIndexChanged;
        ...
        internal virtual Button btnEditScriptOnEnter
        {
            ...
            set
            {
                if (_btnEditScriptOnEnter != null)
                    _btnEditScriptOnEnter.Click -= btnEditScript_Click;
        ...
        internal virtual Button btnEditScriptOnExit
        {
            ...
            set
            {
                if (_btnEditScriptOnExit != null)
                    _btnEditScriptOnExit.Click -= btnEditScript_Click;
        ...
        internal virtual Button btnEditScriptUserDefine
        {
            ...
            set
            {
                if (_btnEditScriptUserDefine != null)
                    _btnEditScriptUserDefine.Click -= btnEditScript_Click;
        ...
        internal virtual Button btnEditScriptHeartbeat
        {
            ...
            set
            {
                if (_btnEditScriptHeartbeat != null)
                    _btnEditScriptHeartbeat.Click -= btnEditScript_Click;
        ...
        internal virtual Button btnEditOnClick
        {
            ...
            set
            {
                if (_btnEditOnClick != null)
                    _btnEditOnClick.Click -= btnEditScript_Click;
        ...
        {
            Load += frmUTT_Editor_Load;
            Closing += frmUTT_Editor_Closing;
            ComboBoxSettingError = false;
            m_bSaveGameMode = false;
            InitializeComponent();
        }

        public frmUTT_Editor(ClsUtt UTTClass, int KotorVerIndex, bool IsDirectEdit = false, string EditingPath = "")
            : this()
        {
            if (IsDirectEdit)
            {
            ...
            m_defaultTitleText = "Trigger Editor - KotOR ";
        ...
        {
            FillComboBoxFrom2DA(cmbxFaction, "label", "repute", ChitinKey.KxChitinKey(KotorVersionIndex), null);
        ...
        private void CustomizeForKotorII()
        {
            nudTrapType.Maximum = new Decimal(26L);
        }
        ...
        private void btnSave_Click(object sender, EventArgs e)
        {
            ...
            UTT.WriteFile(m_EditingFilePath, "UTT");
            if (!m_bSaveGameMode)
            {
                return;
            }
        ...
        private void frmUTT_Editor_Load(object sender, EventArgs e)
        {
        ...
        {
            Text = "Trigger Editor - " + Name;
        }

        private void cmbxType_SelectedIndexChanged(object sender, EventArgs e)
        {
            TabPageTrap.Enabled = cmbxType.SelectedIndex == 2;
        }
