...
// Type: KotorTool_2.frmItemPropertyEditor
...
namespace KotorTool_2._0.Ui.ItemPropertyEditor
{
  public class frmItemPropertyEditor : frmParent
  {
    ...
    internal virtual ComboBox cmbxPropertyName
    {
      ...
      [MethodImpl(MethodImplOptions.Synchronized)] set
      {
        if (_cmbxPropertyName != null)
          _cmbxPropertyName.SelectedIndexChanged -= cmbxPropertyName_SelectedIndexChanged;
    ...
    internal virtual ComboBox cmbxSubtype
    {
      ...
      [MethodImpl(MethodImplOptions.Synchronized)] set
      {
        if (_cmbxSubtype != null)
          _cmbxSubtype.SelectedIndexChanged -= cmbxSubtype_SelectedIndexChanged;
        _cmbxSubtype = value;
        if (_cmbxSubtype == null)
          return;
        _cmbxSubtype.SelectedIndexChanged += cmbxSubtype_SelectedIndexChanged;
    ...
    internal virtual ComboBox cmbxParam1Value
    {
      ...
      [MethodImpl(MethodImplOptions.Synchronized)] set
      {
        if (_cmbxParam1Value != null)
          _cmbxParam1Value.SelectedIndexChanged -= cmbxParam1Value_SelectedIndexChanged;
    ...
    internal virtual ComboBox cmbxCostValue
    {
      ...
      [MethodImpl(MethodImplOptions.Synchronized)] set
      {
        if (_cmbxCostValue != null)
          _cmbxCostValue.SelectedIndexChanged -= cmbxCostValue_SelectedIndexChanged;
    ...
    internal virtual ComboBox cmbxParam2Value
    {
      ...
      [MethodImpl(MethodImplOptions.Synchronized)] set
      {
        if (_cmbxParam2Value != null)
          _cmbxParam2Value.SelectedIndexChanged -= cmbxParam2Value_SelectedIndexChanged;
    ...
    public frmItemPropertyEditor(int PropertyID, int SubtypeID, int CostTableID, int CostTableValue, int Param1ID, int Param1Value, int Param2ID, int Param2Value, int KotorVerIndex)
      : this(KotorVerIndex)
    {
    ...
    {
      itempropdef = ReadCls2DA("itempropdef", g_clsChitinKey);
      iprp_costtable = ReadCls2DA("iprp_costtable", g_clsChitinKey);
      iprp_paramtable = ReadCls2DA("iprp_paramtable", g_clsChitinKey);
    }
    ...
    private void cmbxPropertyName_SelectedIndexChanged(object sender, EventArgs e)
    {
      ...
      if (StringType.StrCmp(indiceData1, "****", false) == 0)
      {
        ...
        {
          FillComboBoxFrom2DA(cmbxCostValue, "name", ReadCls2DA(iprp_costtable.GetIndiceData(IntegerType.FromString(indiceData2), "name"), g_clsChitinKey), g_clsDialogTlk);
      ...
      else
      {
        ...
        Cls2Da TwoDA = ReadCls2DA(indiceData1, g_clsChitinKey);
      ...
      else
      {
        ...
        FillComboBoxFrom2DA(cmbxParam1Value, "name", ReadCls2DA(indiceData4, g_clsChitinKey), g_clsDialogTlk);
    ...
    private void cmbxSubtype_SelectedIndexChanged(object sender, EventArgs e)
    {
      if (g_bCmbxPropertyHasParam1ResRef)
        return;
      Cls2Da cls2Da = ReadCls2DA(itempropdef.GetIndiceData(cmbxPropertyName.SelectedIndex, "subtyperesref"), g_clsChitinKey);
      bool flag1 = false;
      int num1 = 0;
      ...
      if (flag1)
      {
        ...
        else
        {
          ...
          FillComboBoxFrom2DA(cmbxParam1Value, "name", ReadCls2DA(indiceData2, g_clsChitinKey), g_clsDialogTlk);
      ...
      if (flag2)
      {
        string indiceData1 = cls2Da.GetIndiceData(cmbxSubtype.SelectedIndex, "param2resref");
        tbParam2resref.Text = indiceData1;
        if (StringType.StrCmp(indiceData1, "****", false) == 0)
        {
          cmbxParam2Value.Enabled = false;
          cmbxParam2Value.Items.Clear();
        ...
        else
        {
          ...
          int rowNumber = IntegerType.FromString(indiceData1);
          string indiceData2 = iprp_paramtable.GetIndiceData(rowNumber, "tableresref");
          FillComboBoxFrom2DA(cmbxParam2Value, "name", ReadCls2DA(indiceData2, g_clsChitinKey), g_clsDialogTlk);
          tbParam2tableresref.Text = indiceData2;
    ...
    {
      return cmbxPropertyName.SelectedIndex != -1 && !(cmbxSubtype.Enabled & cmbxSubtype.SelectedIndex == -1) && (!(cmbxCostValue.Enabled & cmbxCostValue.SelectedIndex == -1) && !(cmbxParam1Value.Enabled & cmbxParam1Value.SelectedIndex == -1)) && !(cmbxParam2Value.Enabled & cmbxParam2Value.SelectedIndex == -1);
    }
    ...
    private void cmbxCostValue_SelectedIndexChanged(object sender, EventArgs e)
    {
      btnOK.Enabled = ValidateForm();
    }

    private void cmbxParam1Value_SelectedIndexChanged(object sender, EventArgs e)
    {
      btnOK.Enabled = ValidateForm();
    }

    private void cmbxParam2Value_SelectedIndexChanged(object sender, EventArgs e)
    {
      btnOK.Enabled = ValidateForm();
    }
  }
