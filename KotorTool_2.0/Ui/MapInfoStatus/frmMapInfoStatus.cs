...
namespace KotorTool_2._0.Ui.MapInfoStatus
{
    public class FrmMapInfoStatus : Form
    {
        ...
        public static MapInfo ReadMapInfoFile()
        {
            ...
            Stream serializationStream1 = File.OpenRead(MainAppState.GameRootPath + "MapInfo.bfd");
            MapInfo mapInfo;
            try
            {
            ...
            catch (Exception ex)
            {
                ...
                {
                    Stream serializationStream2 = File.OpenWrite(MainAppState.GameRootPath + "MapInfo.bfd");
