...
// Type: KotorTool_2.frmModuleEditorOptions
...
namespace KotorTool_2._0.Ui.ModuleEditor
{
  public class frmModuleEditorOptions : Form
  {
    ...
    private void InitializeComponent()
    {
      ...
      Decimal num1 = new Decimal(new int[4]{ 25, 0, 0, 131072 });
      Decimal num2 = num1;
      ...
      MinimumSize = size1;
      Name = "frmModuleEditorOptions";
      SizeGripStyle = SizeGripStyle.Hide;
      StartPosition = FormStartPosition.CenterParent;
      Text = "Module Editor ConfigOptions";
      nudDotSize.EndInit();
      ResumeLayout(false);
    }
