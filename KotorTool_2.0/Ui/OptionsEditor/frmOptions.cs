...
namespace KotorTool_2._0.Ui.OptionsEditor
{
  public class frmOptions : Form
  {
    ...
    internal virtual CheckBox chkbCheckForUpdatesAtStartup
    {
      ...
      [MethodImpl(MethodImplOptions.Synchronized)] set
      {
        if (_chkbCheckForUpdatesAtStartup != null)
          _chkbCheckForUpdatesAtStartup.CheckedChanged -= chkbCheckForUpdatesAtStartup_CheckedChanged;
    ...
    internal virtual RadioButton rbProjMgrUseExternDLGEditor
    {
      ...
      [MethodImpl(MethodImplOptions.Synchronized)] set
      {
        if (_rbProjMgrUseExternDLGEditor != null)
          _rbProjMgrUseExternDLGEditor.CheckedChanged -= RbProjectManagerUseExternDlgEditorOnCheckedChanged;
    ...
    internal virtual RadioButton rbProjMgrUseExternTxtEditor
    {
      ...
      [MethodImpl(MethodImplOptions.Synchronized)] set
      {
        if (_rbProjMgrUseExternTxtEditor != null)
          _rbProjMgrUseExternTxtEditor.CheckedChanged -= RbProjectManagerUseExternTextEditorOnCheckedChanged;
    ...
    internal virtual Button btnBrowseProjMgrDLGEditorPath
    {
      ...
      [MethodImpl(MethodImplOptions.Synchronized)] set
      {
        if (_btnBrowseProjMgrDLGEditorPath != null)
          _btnBrowseProjMgrDLGEditorPath.Click -= btnBrowseProjMgrDLGEditorPath_Click;
    ...
    internal virtual Button btnBrowseProjMgrTxtEditorPath
    {
      ...
      [MethodImpl(MethodImplOptions.Synchronized)] set
      {
        if (_btnBrowseProjMgrTxtEditorPath != null)
          _btnBrowseProjMgrTxtEditorPath.Click -= BrowseProjectManagerTxtEditorPathOnClick;
    ...
    {
      /*
      chkbBuildBIFTreeAtStartup.Checked = ConfigOptions.BBuildBifFtreeOnStartup;
      chkbBuildModelsBifNode.Checked = ConfigOptions.BBuildModelsBifNode;
      chkbAlwaysUnknownGFFasText.Checked = ConfigOptions.BAlwaysUnknownGfFasText;
      chkbAlwaysConvertTPC2TGA.Checked = ConfigOptions.BAlwaysConvertTpc2Tga;
      chkbDockImageViewer.Checked = ConfigOptions.BDockImageViewer;
      chkbTextEditorWordWrap.Checked = ConfigOptions.BTextEditorWordWrap;
      chkbShowModuleDescriptions.Checked = ConfigOptions.BShowModuleDescriptions;
      chkbShowModuleLocations.Checked = ConfigOptions.BShowModuleLocations;
      chkbCheckForUpdatesAtStartup.Checked = ConfigOptions.BCheckForUpdatesAtStartup;
      chkbDownloadUpdatesAutomatically.Checked = ConfigOptions.BDownloadUpdatesAutomatically & chkbCheckForUpdatesAtStartup.Checked;
      chkbRememberLastTreeNode.Checked = ConfigOptions.BRememberLastTreeNode;
      chkbRememberTreeViewState.Checked = ConfigOptions.BRememberTreeViewState;
      chkbUseOverrideFiles.Checked = ConfigOptions.BUseOverrideFiles;
      if (ConfigOptions.BProjMgrUseExternTxtEditor && StringType.StrCmp(ConfigOptions.ProjMgrTxtEditorPath, "", false) != 0)
      {
        rbProjMgrUseExternTxtEditor.Checked = true;
        tbProjMgrTxtEditorPath.Text = ConfigOptions.ProjMgrTxtEditorPath;
      }
      else
        rbProjMgrUseInternTxtEditor.Checked = true;
      if (ConfigOptions.BProjMgrUseExternDlgEditor && StringType.StrCmp(ConfigOptions.ProjMgrDlgEditorPath, "", false) != 0)
      {
        rbProjMgrUseExternDLGEditor.Checked = true;
        tbProjMgrDLGEditorPath.Text = ConfigOptions.ProjMgrDlgEditorPath;
      }
      else
        rbProjMgrUseInternDLGEditor.Checked = true;
        */
    ...
    {
      ConfigOptions.Toggles.BuildBiffTreeOnStartup = chkbBuildBIFTreeAtStartup.Checked;
      ConfigOptions.Toggles.BuildModelsBifNode = chkbBuildModelsBifNode.Checked;
      ConfigOptions.Toggles.AlwaysUnknownGfFasText = chkbAlwaysUnknownGFFasText.Checked;
      ConfigOptions.Toggles.AlwaysConvertTpc2Tga = chkbAlwaysConvertTPC2TGA.Checked;
      ConfigOptions.Toggles.DockImageViewer = chkbDockImageViewer.Checked;
      ConfigOptions.Toggles.TextEditorWordWrap = chkbTextEditorWordWrap.Checked;
      ConfigOptions.Toggles.ShowModuleDescriptions = chkbShowModuleDescriptions.Checked;
      ConfigOptions.Toggles.ShowModuleLocations = chkbShowModuleLocations.Checked;
      ConfigOptions.Toggles.CheckForUpdatesAtStartup = chkbCheckForUpdatesAtStartup.Checked;
      ConfigOptions.Toggles.DownloadUpdatesAutomatically = chkbDownloadUpdatesAutomatically.Checked;
      if (!ConfigOptions.Toggles.RememberLastTreeNode & chkbRememberLastTreeNode.Checked)
        ConfigOptions.Paths.LastClickedTvNodePath = string.Empty;
      ConfigOptions.Toggles.RememberLastTreeNode = chkbRememberLastTreeNode.Checked;
      ConfigOptions.Toggles.RememberTreeViewState = chkbRememberTreeViewState.Checked;
      ConfigOptions.Toggles.UseOverrideFiles = chkbUseOverrideFiles.Checked;
      if (rbProjMgrUseExternTxtEditor.Checked && StringType.StrCmp(tbProjMgrTxtEditorPath.Text.Trim(), string.Empty , false) != 0)
      {
        ConfigOptions.Toggles.ProjMgrUseExternTxtEditor = true;
        ConfigOptions.Paths.ProjMgrTxtEditorPath = tbProjMgrTxtEditorPath.Text;
      }
      else
      {
        ConfigOptions.Toggles.ProjMgrUseExternTxtEditor = false;
        ConfigOptions.Paths.ProjMgrTxtEditorPath = "";
      }
      if (rbProjMgrUseExternDLGEditor.Checked && StringType.StrCmp(tbProjMgrDLGEditorPath.Text.Trim(), string.Empty , false) != 0)
      {
        ConfigOptions.Toggles.ProjMgrUseExternDlgEditor = true;
        ConfigOptions.Paths.ProjMgrDlgEditorPath = tbProjMgrDLGEditorPath.Text;
      }
      else
      {
        ConfigOptions.Toggles.ProjMgrUseExternDlgEditor = false;
        ConfigOptions.Paths.ProjMgrDlgEditorPath = string.Empty;
      }
     // UserSettings.SaveSettings(ConfigOptions);
    }
    ...
    {
      string sLeft = StringType.FromObject(FileUtils.GetFilePath("load", "C:\\", "*.exe", "Select the Dialog Editor you wish to use", ""));
      if (StringType.StrCmp(sLeft, String.Empty, false) == 0)
        return;
      tbProjMgrDLGEditorPath.Text = sLeft;
    }

    private void BrowseProjectManagerTxtEditorPathOnClick(object sender, EventArgs e)
    {
      string sLeft = StringType.FromObject(FileUtils.GetFilePath("load", "C:\\", "*.exe", "Select the Text Editor you wish to use", ""));
      if (StringType.StrCmp(sLeft, string.Empty, false) == 0) return;
      tbProjMgrTxtEditorPath.Text = sLeft;
    }

    private void RbProjectManagerUseExternDlgEditorOnCheckedChanged(object sender, EventArgs e)
    {
    ...
    private void RbProjectManagerUseExternTextEditorOnCheckedChanged(object sender, EventArgs e)
    {
      bool flag = ((RadioButton) sender).Checked;
